				...
				<form class="form-horizontal" method="POST" action="/create">
			      	<?php if(empty($errors['title'])): ?>
						<div class="form-group">
			    			<label for="name" class="col-sm-4 control-label">LISTING TITLE</label>
			    			<div class="col-sm-8">
					...
					<?php if(empty($errors['price'])): ?>
						<div class="form-group">
				    		<label for="location" class="col-sm-4 control-label">PRICE</label>
				    		<div class="col-sm-8">
			  		...
			  		<?php if(empty($errors['msrp'])): ?>
						<div class="form-group">
				    		<label for="msrp" class="col-sm-4 control-label">MSRP</label>
				    		<div class="col-sm-8">
			  		...
			  		<?php else: ?>
			  			...
			  			<div class="form-group has-error">
			    			<label for="contact_name" class="col-sm-4 control-label">CONTACTN NAME</label>
			    			<div class="col-sm-8">
			  	...
			  	<button class="btn btn-default" type="submit">CREATE LISTING</button>
				</form>
			</section>
